...
from locators.enterprise_data_centers_locators import PLDTDataCentersLocators as PLDT


# ── Fixtures ──────────────────────────────────────────────────────────────────

@pytest.fixture(autouse=True)
def navigate_to_data_centers_page(page: Page):
...
class TestDataCentersBreadcrumbs:
...
class TestDataCentersHero:
    ...
    def test_learn_more_link_interaction(self, page: Page):
        ...
        # Act and track changing location context safely
